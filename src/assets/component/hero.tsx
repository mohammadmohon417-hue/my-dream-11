const Hero = () => {
  return (
    <section id="home" className="px-5 md:px-8 lg:px-10 mt-6">
      ...
      "
        ...
        "
          ...
          "
            >
              Pick your favorite BPL stars, manage your coins, and build the
              ultimate fantasy cricket team.
            </p>
          ...
          "
            ...
            <div className="flex items-center gap-6 md:gap-10 mt-8">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-gray-400">Fantasy Fun</p>
              </div>
            </div>
          </div>
        </div>
